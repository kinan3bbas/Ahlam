    ...
    */
    ...
    public class UsersDeviceTokensController : ODataController
    {
        ...
        public async Task<IHttpActionResult> Post(UsersDeviceTokens usersDeviceTokens)
        {
            ...
            if (usersDeviceTokens.PhoneNumber == null)
            {
                return BadRequest("Phonenumber can't be null!");
            }
            ApplicationUser user = db.Users.Where(a=>a.PhoneNumber.Equals(usersDeviceTokens.PhoneNumber)).FirstOrDefault();
            if (user == null)
            {
            ...
            else
            {
                ...
                usersDeviceTokens.UserId = user.Id;
